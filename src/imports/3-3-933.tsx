import svgPaths from "./svg-5877tikic2";
...
function Logo() {
  return (
    <div className="absolute flex items-center gap-[8px] h-[28px] left-[16px] top-[17px]" data-name="Logo">
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        <rect width="28" height="28" rx="8" fill="#F97316" />
        <path d="M8 14C10 10 12 18 14 14C16 10 18 18 20 14" stroke="white" strokeLinecap="round" strokeWidth="2.5" />
      </svg>
      <span className="font-['Archivo:SemiBold',sans-serif] font-semibold text-[16px] text-black tracking-[-0.32px]" style={{ fontVariationSettings: "'wdth' 100" }}>Acme</span>
    </div>
  );
}
