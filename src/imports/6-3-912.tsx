import svgPaths from "./svg-2akxasmgxn";
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="analytics">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="analytics">
          <mask height="20" id="mask0_3_953" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
...
function Apps() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="apps">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="apps">
          <mask height="20" id="mask0_3_961" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_3_961)">
