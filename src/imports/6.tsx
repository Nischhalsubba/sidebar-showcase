import svgPaths from "./svg-m8bk5jqqed";
import imgMemoji from "../assets/51a78c35a082b55febc505e1c88cd9f81ee2840b.png";

function SidebarIcon() {
  return (
    <div className="relative shrink-0 size-[28px]" data-name="Sidebar Icon 1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 28">
        <g clipPath="url(#clip0_1_1025)" id="Sidebar Icon 1">
          <rect fill="var(--fill-0, #3B82F6)" height="28" id="Sidebar Icon Background 1" rx="8" width="28" />
  ...
  return (
    <div className="relative shrink-0 size-[20px]" data-name="analytics">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="analytics">
          <mask height="20" id="mask0_1_1017" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_1_1017)">
            <path d={svgPaths.p2a6c4a00} fill="var(--fill-0, black)" id="analytics_2" />
          </g>
        </g>
      </svg>
    </div>
...
function SidebarIcon1() {
  return (
    <div className="content-stretch flex items-start opacity-50 px-[12px] py-[6px] relative rounded-[8px] shrink-0" data-name="Sidebar Icon 2">
      <Analytics />
    </div>
  );
}
...
function Apps() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="apps">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="apps">
          <mask height="20" id="mask0_1_1021" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_1_1021)">
            <path d={svgPaths.p2808a700} fill="var(--fill-0, #3B82F6)" id="apps_2" />
          </g>
        </g>
      </svg>
    </div>
...
function SidebarIcon2() {
  return (
    <div className="bg-[#eef1f8] content-stretch flex items-start px-[12px] py-[6px] relative rounded-[8px] shrink-0" data-name="Sidebar Icon 3">
      <Apps />
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[20px]" data-name="article_shortcut">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="article_shortcut">
          <mask height="20" id="mask0_1_997" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_1_997)">
            <path d={svgPaths.p1ddc5571} fill="var(--fill-0, #1C1B1F)" id="article_shortcut_2" />
          </g>
        </g>
      </svg>
    </div>
...
function SidebarIcon3() {
  return (
    <div className="content-stretch flex items-start opacity-50 px-[12px] py-[6px] relative shrink-0" data-name="Sidebar Icon 4">
      <ArticleShortcut />
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[20px]" data-name="auto_awesome_mosaic">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="auto_awesome_mosaic">
          <mask height="20" id="mask0_1_985" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_1_985)">
            <path d={svgPaths.p2c5a2000} fill="var(--fill-0, #1C1B1F)" id="auto_awesome_mosaic_2" />
          </g>
        </g>
      </svg>
    </div>
...
function SidebarIcon4() {
  return (
    <div className="content-stretch flex items-start opacity-50 px-[12px] py-[6px] relative shrink-0" data-name="Sidebar Icon 5">
      <AutoAwesomeMosaic />
    </div>
  );
}
...
function CardTravel() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="card_travel">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="card_travel">
          <mask height="20" id="mask0_1_981" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
          <g mask="url(#mask0_1_981)">
            <path d={svgPaths.p2f413380} fill="var(--fill-0, #1C1B1F)" id="card_travel_2" />
          </g>
        </g>
      </svg>
    </div>
...
function SidebarIcon5() {
  return (
    <div className="content-stretch flex items-start opacity-50 px-[12px] py-[6px] relative shrink-0" data-name="Sidebar Icon 6">
      <CardTravel />
    </div>
  );
}

function SidebarIconGroup() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start relative shrink-0" data-name="Sidebar Icon Group">
      <SidebarIcon1 />
      <SidebarIcon2 />
      <SidebarIcon3 />
      <SidebarIcon4 />
...
function SidebarIcons() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[30px] items-center left-[7px] top-[15px]" data-name="Sidebar Icons">
      <SidebarIcon />
      <SidebarIconGroup />
    </div>
  );
...
function Memoji() {
  return (
    <div className="absolute bg-[#d7d7d9] left-[10px] overflow-clip rounded-[99px] size-[37px] top-[966.5px]" data-name="memoji">
...
function SidebarFooter() {
  return (
    <div className="absolute bg-white border border-[rgba(0,0,0,0.1)] border-solid h-[1016px] left-[4px] overflow-clip rounded-[8px] top-[4px] w-[60px]" data-name="Sidebar Footer">
      <SidebarIcons />
      <Memoji />
    </div>
  );
...
function DashboardItem() {
  return (
    <div className="content-stretch flex gap-[8px] items-center py-[4px] relative shrink-0 w-full" data-name="Dashboard Item">
      <DashboardIcon />
    ...
    <div className="relative size-[20px]" data-name="arrow_drop_down">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="arrow_drop_down">
          <mask height="20" id="mask0_1_989" maskUnits="userSpaceOnUse" style={{ maskType: "alpha" }} width="20" x="0" y="0">
            <rect fill="var(--fill-0, #D9D9D9)" height="20" id="Bounding box" width="20" />
          </mask>
...
function Menu() {
  return (
    <div className="-translate-x-1/2 absolute bg-white content-stretch flex flex-col gap-[20px] items-start left-1/2 top-[107px] w-[217px]" data-name="Menu">
      <GeneralSection />
      <AnalystsSection />
    </div>
  );
...
function Sidebar() {
  return (
    <div className="absolute h-[1024px] left-[70px] overflow-clip top-0 w-[207px]" data-name="Sidebar">
